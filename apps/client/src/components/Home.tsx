        ...
        <div className="min-h-screen">
            ...
            <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-6 pt-12 pb-20">
                ...
                <div className="mb-6 max-w-3xl text-center">
                    ...
                    <p className="text-[#998C8C] text-base lg:text-xl font-medium mb-2">Where Teaching and Learning Come Together,</p>
                    <p className="text-[#998C8C] text-base lg:text-xl font-medium">Where instruction meets inspiration.</p>
                </div>


                <div className="flex gap-4 justify-center mb-12">
                    <Link to="/signup" className="bg-[#BB8856] hover:bg-[#A87744] text-white font-semibold px-4 py-3 lg:px-8 lg:py-3 rounded-xl shadow-md transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5">
                        Get Started Free
                    </Link>
                    <a href="#how-it-works" className="border border-[#BB8856] text-[#BB8856] font-semibold px-4 py-3 lg:px-8 lg:py-3 rounded-xl transition-all duration-200">
                        See How It Works
                    </a>
                </div>
            ...
            <div id="how-it-works" className="bg-[#0F0D0B] px-16 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3">
                    ...
                    <div className="bg-[#1A1714] p-8 lg:px-8 lg:py-12">
                        ...
                        <p className="text-[#888] text-sm leading-relaxed max-w-[310px]">Import any PDF or PowerPoint. Presento keeps your slides exactly as you made them.</p>
                    </div>
                    ...
                    <div className="bg-[#C49A5A] p-8">
                        ...
                        <p className="text-[#f5e8d4] text-sm leading-relaxed max-w-[380px]">Create an account, share a room code,  students join with a single code, no downloads, no friction.</p>
                    </div>
                    ...
                    <div className="bg-[#1A1714] p-8">
                        ...
                        <p className="text-[#888] text-sm leading-relaxed max-w-[310px]">Students see your slides in real time. They react, respond, and stay engaged throughout.</p>
                    </div>
                </div>
            </div>
            <div id="why-presento" className="bg-[#FEF8F0] px-16 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-[#EFE3D0] rounded-2xl p-8">
                        ...
                        <p className="text-[#7A6A5A] text-sm leading-relaxed max-w-[280px]">Every slide change you make is instantly visible to all students in the room, no refresh needed.</p>
                    </div>
                    ...
                    <div className="bg-[#EFE3D0] rounded-2xl p-8">
                        ...
                        <p className="text-[#7A6A5A] text-sm leading-relaxed max-w-[280px]">Teachers control the flow. Students follow along. Each side sees exactly what they need to.</p>
                    </div>
                    <div className="bg-[#EFE3D0] rounded-2xl p-8">
                        <div className="w-10 h-10 bg-[#C49A5A] rounded-lg mb-6 flex items-center justify-center">
                        ...
                        <p className="text-[#7A6A5A] text-sm leading-relaxed max-w-[280px]">Students join through the browser. Nothing to install.</p>
                    </div>
                </div>
            </div>

            <div className="bg-[#0F0D0B] px-16 py-16">
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between lg:px-16">
                    <div className="flex flex-col justify-between min-h-[160px]">
                        <div>
                            <h3 className="text-[#ECE7E2] text-3xl font-semibold tracking-[0.04em] mb-3">Presento</h3>
                            <p className="text-[#7D7A76] text-sm">Where teaching and learning come together.</p>
                        </div>
